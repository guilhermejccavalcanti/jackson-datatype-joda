...
public class JacksonJodaDateFormat extends JacksonJodaFormatBase {
    ...
    public JacksonJodaDateFormat withAdjustToContextTZOverride(Boolean adjustToContextTZOverride) {
        if ((adjustToContextTZOverride == null) || (_adjustToContextTZOverride != null && _adjustToContextTZOverride.equals(adjustToContextTZOverride))) {
            return this;
        }
        DateFormatSetup setup = getSetup();
    ...
    private boolean isAdjustDatesToContextTimeZone(DeserializationContext ctxt) {
        return _adjustToContextTZOverride != null ? _adjustToContextTZOverride : ctxt.isEnabled(DeserializationFeature.ADJUST_DATES_TO_CONTEXT_TIME_ZONE);
    }
    ...
    public String toString() {
        return String.format("[JacksonJodaFormat, explicitTZ? %s, JDK tz = %s, formatter = %s]", _explicitTimezone, _jdkTimezone.getID(), _formatter);
    }
}
